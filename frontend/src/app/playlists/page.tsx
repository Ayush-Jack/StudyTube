...
import { ListVideo, HelpCircle } from "lucide-react";
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-6 pb-16">
        ...
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-xl bg-brand-500/15 flex items-center justify-center">
            <ListVideo size={20} className="text-brand-400" />
          </div>
        ...
        <div className="flex flex-col items-center justify-center py-24 gap-4">
          <div className="w-20 h-20 rounded-2xl bg-brand-500/10 flex items-center justify-center">
            <ListVideo size={36} className="text-brand-400/60" />
          </div>
          ...
          <p className="text-sm text-[#8b90a7] light:text-[#3d4a6b] max-w-sm text-center">
            This page is under construction. Stay tuned for Playlists content!
          </p>
          <Link
            href="/help"
